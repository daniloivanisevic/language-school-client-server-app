 ...
 * @author dakik
 */
public class IzmeniNastavnaJedinicaSO extends ApstraktnaGenerickaOperacija{
    ...
    protected void preduslovi(Object objekat) throws Exception {
        ...
        if(k.getNaziv()==null || k.getNaziv().isEmpty()){
            ...
            throw new Exception("Greska - nema opisa nastavne jedinice!");
        }
    }

    @Override
    protected void izvrsiOperaciju(Object objekat, String kljuc) throws Exception {
        broker.edit((NastavnaJedinica) objekat);
    }
